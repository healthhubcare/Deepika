...
<p>
Wieldy Bank offers affordable and flexible housing loans that can turn your dreamof owning a home into reality.

We have products to suit every budget, taste and need. Whether you are self-employedor salaried, want a floating or fixed rate,Wieldy Bank will offer a loan that isjust right for you.

Our offerings
Loans with up to 12 EMIs waived off* on regular repayment of all other EMIs 
Nil prepayment charges*
Loan tenure up to 30 years
Balance transfer and top-up loan available
</p>
<form>
...
<tr><td>Mobile no:<td><input type="text" name="mobile"></td></tr>
<tr><td>State:<td><select name="state">
...
<tr><td align="center"><td><a href="homefinal.jsp"><input type="button" name="button" value="submit"></a>
</table>
</form>
